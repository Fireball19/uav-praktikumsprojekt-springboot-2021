...
Die Anwendung versucht sich im 10 Sekunden Interval mit der Datenbank zu verbinden, sollte diese noch nicht gestartet sein wird ein Exception-Stacktrace ausgegeben, doch diesen kann man ignorieren.
[source]
----
