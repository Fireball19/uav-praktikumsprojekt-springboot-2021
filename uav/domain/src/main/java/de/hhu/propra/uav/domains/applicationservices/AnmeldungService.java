...
public class AnmeldungService {
  ...
  public AnmeldungService(final UebungService uebungService,
  ...
  public void individualAnmeldung(final Long uebungId, final LocalDateTime zeitpunkt,
  ...
  public void gruppenAnmeldung(final Long uebungId, final Long terminId,
    ...
    if (split.length < uebungService.ueberpruefeMinGroesse(uebungId)) {
      throw new HttpClientErrorException(HttpStatus.CONFLICT,
          "Die Anzahl der eingetragenen Mitglieder "
              + "liegt unter der minimalen Gruppengröße " + uebungService
              .ueberpruefeMinGroesse(uebungId) + "!");
    }
    if (split.length > uebungService.ueberpruefeMaxGroesse(uebungId)) {
      throw new HttpClientErrorException(HttpStatus.CONFLICT,
          "Die Anzahl der eingetragenen Mitglieder "
              + "übersteigt die maximale Gruppengröße " + uebungService
              .ueberpruefeMaxGroesse(uebungId) + "!");
    }
